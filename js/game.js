...
let enemy = {
  ...
  frameTimer: 0,
  frameInterval: 200,
  width: 96,    // กว้างเฟรมศัตรู (576 / 6)
  height: 96,   // สูงเฟรมศัตรู
  scale: 0.6,   // ปรับ scale ให้ใหญ่ขึ้น
  totalFrames: 6
};
...
function draw(deltaTime) {
  ...
  // ปรับตำแหน่งศัตรูให้อยู่ระดับพื้น
  enemy.y = groundY - drawEnemyHeight;

  const enemySx = enemy.frame * enemy.width;
